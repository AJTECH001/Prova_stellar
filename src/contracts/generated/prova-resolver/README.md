...
contract `prova-resolver` via Soroban RPC.
...
soroban contract bindings ts \
  ...
  --contract-id CBDH2QTTL7ELT6FY5AATQ7DBNPTEE6PSUMRUO4PDYZ6ZH5AX7TGIL3AC \
  --output-dir ./path/to/prova-resolver
```
...
```json
"dependencies": {
  "prova-resolver": "./path/to/this/folder"
}
```
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url https://soroban-testnet.stellar.org --network-passphrase \"Test SDF Network ; September 2015\" --id CBDH2QTTL7ELT6FY5AATQ7DBNPTEE6PSUMRUO4PDYZ6ZH5AX7TGIL3AC --name prova-resolver"
}
```
...
```js
import { Contract, networks } from "prova-resolver"

...
contract `prova-pool` via Soroban RPC.
...
soroban contract bindings ts \
  ...
  --contract-id CADOPOLTIJGPTRCJ4HPVLG6ZKQTT4U4OHZX7ZKQKHWLVVXH3B7RFZMXT \
  --output-dir ./path/to/prova-pool
```
...
```json
"dependencies": {
  "prova-pool": "./path/to/this/folder"
}
```
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url https://soroban-testnet.stellar.org --network-passphrase \"Test SDF Network ; September 2015\" --id CADOPOLTIJGPTRCJ4HPVLG6ZKQTT4U4OHZX7ZKQKHWLVVXH3B7RFZMXT --name prova-pool"
}
```
...
```js
import { Contract, networks } from "prova-pool"

...
soroban contract bindings ts \
  ...
  --contract-id CCH65QVYJZHJ6RI6KCDVLLVN56CSWREOUP3PTVQB7LDZOWXSXIE36SQS \
  --output-dir ./path/to/exposure-registry
```
...
```json
"dependencies": {
  "exposure-registry": "./path/to/this/folder"
}
```
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url https://soroban-testnet.stellar.org --network-passphrase \"Test SDF Network ; September 2015\" --id CCH65QVYJZHJ6RI6KCDVLLVN56CSWREOUP3PTVQB7LDZOWXSXIE36SQS --name exposure-registry"
}
```
...
```js
import { Contract, networks } from "exposure-registry"
